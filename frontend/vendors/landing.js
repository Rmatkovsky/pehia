$(document).ready(function(){
        ...
        var bxslider = $(".landing .bxslider").length ? $(".landing .bxslider").bxSlider({
            minSlides: 1,
            maxSlides: 7,
            slideWidth: 270,
            pager: false,
        ...
        var slider = $(".landing .slider").length ? $(".slider").bxSlider({
            minSlides: 1,
            maxSlides: 1,
            mode: 'fade',
            autoControls: false,
        ...
        $('.landing .slider').mousewheel(function(event, delta, deltaX, deltaY) {
            if (delta > 0) {
